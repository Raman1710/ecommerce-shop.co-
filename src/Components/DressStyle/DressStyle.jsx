...
function DressStyle() {
  return (
    <div className='bg-[#f0f0f0] mx-[148px]  rounded-[40px] flex flex-col justify-center'>
        <h1 className=' font-integral text-6xl font-bold pt-[68px] pb-[61px] tracking-tighter text-center'>BROWSE BY DRESS STYLE</h1>
